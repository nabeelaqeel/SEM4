...
- ![](../res/Pasted%20image%2020250211202555.png)
...
- ![](../res/Pasted%20image%2020250211202658.png)
- 
...
- Content of each job’s Process Control Block
	- ![](../res/Pasted%20image%2020250211202831.png)
...
- ![](../res/Pasted%20image%2020250211202847.png)
...
- 6 process scheduling algorithms:
	- First-Come, First Served (FCFS)	
		...
		- Timeline for job sequence A, B C using FCFS algorithm.
			- ![](../res/Pasted%20image%2020250211203136.png)
			...
			- $(15 + 17 + 18)/3$ = 16.67
			- ![](../res/Pasted%20image%2020250211203235.png)
	...
	- Shortest Job Next (SJN)
		...
		- Job:		A     B     C     D
		- CPU cycle:	5      2     6     4
		- ![](../res/Pasted%20image%2020250211203525.png)
	...
	- Shortest Remaining Time (SRT)
		...
		- ![](../res/Pasted%20image%2020250211205158.png)
		- Average turnaround time = $$\frac{14 + 4 + 1 + 6}{4} = 6.25$$
		- ![](../res/Pasted%20image%2020250211205305.png)
		- Compare the same job problem using SJN policy.
			- ![](../res/Pasted%20image%2020250211205318.png)
			- ![](../res/Pasted%20image%2020250211205731.png)
	...
	- Round Robin
		...
		- If the job’s CPU cycles is shorter than the time quantum, either:
			...
			- ![](../res/Pasted%20image%2020250211210737.png)
			- ![](../res/Pasted%20image%2020250211210753.png)
			...
			- ![](../res/Pasted%20image%2020250211210906.png)
